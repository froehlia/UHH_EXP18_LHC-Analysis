...
class DefaultHistograms(Histograms):
    ...
    def __init__(self, name):
        self.hists = {'muons_number': TH1F('muons_number','N_#mu', 11,-0.5,10.5),
                      ...
                      'jet1_pt':      TH1F('jet1_pt','p_{T,#mu} [GeV]', 60,0,300),
                      'jet1_eta':     TH1F('jet1_eta','#eta_{#mu}', 50,-5.0,5.0),
                      'jet1_phi':     TH1F('jet1_phi','#phi_{#mu}', 40,-3.2,3.2),
                      'jet2_pt':      TH1F('jet2_pt','p_{T,#mu} [GeV]', 60,0,300),
                      'jet2_eta':     TH1F('jet2_eta','#eta_{#mu}', 50,-5.0,5.0),
                      'jet2_phi':     TH1F('jet2_phi','#phi_{#mu}', 40,-3.2,3.2),
                      'jet3_pt':      TH1F('jet3_pt','p_{T,#mu} [GeV]', 60,0,300),
                      'jet3_eta':     TH1F('jet3_eta','#eta_{#mu}', 50,-5.0,5.0),
                      'jet3_phi':     TH1F('jet3_phi','#phi_{#mu}', 40,-3.2,3.2)
                      }
